...
del LtEnh.exe
cd ..
Installer\7zr a Installer\LtEnh.7z amd64 i386 ia64 wow64 *.msi *.klc setup.exe Installer\config.txt Installer\gensetup.bat -m0=BCJ2 -m1=LZMA:d25:fb255 -m2=LZMA:d19 -m3=LZMA:d19 -mb0:1 -mb0s1:2 -mb0s2:3 -mx
cd Installer
copy /b 7zS.sfx + config.txt + LtEnh.7z LtEnh.exe
del LtEnh.7z